...
tabItem(tabName = "snap_app",
        splitLayout(cellWidths = c("30%", "70%"),
          column(width = 12,
                 ...
                 box(title = tagList(icon("chart-bar"), " Stats. params."), width = 12, collapsible = T, collapsed = F,
                     actionButton(inputId = "show_stats", label = "Show stats")),
                 box(title = tagList(icon("sort-alpha-down"), " Conversion params."), width = 12, collapsible = T, collapsed = F,
                 ...
                 box(title = tagList(icon("dna"), " DNA2Prot prams."), width = 12, collapsible = T, collapsed = F,
                     actionButton(inputId = "do_dna2prot", label = "Translate DNA"))),
           column(width = 12,
              box(title = tagList(icon("chart-bar"), " Statistics"), width = 12,
                  tags$div(tableOutput(outputId = "stats_table"), style = "font-family:courier;")),
              box(title = tagList(icon("sort-alpha-down"), " Seq. conversion"), width = 12,
                  tags$div(tableOutput(outputId = "conversion_table"), style = "font-family:courier;")),
              #box(title = "Restriction targets",  width = 12,),
              box(title = tagList(icon("dna"), " DNA2Prot"), width = 12,
